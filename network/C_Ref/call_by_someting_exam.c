/*
   ...
   따라서 사람들은 서브루틴이라는 개념(추상적 개념)을 사용해서 프로그램을 작성하게 된다. 그럼 서브루틴을 뭘까?
   서브루틴은 사용자가 정의한 작업을 수행하는 명령어 모음으로, 하나의 단위로 간주할 수 있다. 
   또한 서브루틴은 다양한 언어에서 다양한 구현(제공하는 문법)방식으로 제공된다.
   ...
   * 초기화된 데이터 세그먼트: 명시적으로 초기화된 전역 변수와 정적 변수를 담고 있다.
